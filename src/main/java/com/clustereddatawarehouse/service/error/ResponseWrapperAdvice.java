...
public class ResponseWrapperAdvice implements ResponseBodyAdvice<Object> {
    ...
    @ExceptionHandler
    public ResponseEntity<GenericResponse<ErrorResponse>> handleAllException(Exception ex,  Locale locale) {log.info("START: writing generic error response to object..");
    ...
    private ErrorResponse problemDelegator(Exception exception, Locale locale) {
        ...
        if (exception instanceof ValidationException) {
            ...
            Function<ErrorValidator, String> localeMapper = validatorError ->
