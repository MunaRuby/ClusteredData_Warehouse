package com.clustereddatawarehouse.logger;
...
public class FxDealLogger {
    ...
    @Pointcut(
            "within(com.data.warehouse.repository..*)" +
                    " || within(com.data.warehouse.service..*)" +
                    " || within(com.data.warehouse.controller..*)"
    )
